        ...
        if (count($data) > 1) { // jika data lebih dari 1 baris                 
            foreach ($data as $baris => $value) {
                if ($baris > 1) { // baris ke 1 adalah header, maka lewati 
                    ...
                    // Ganti kata 'kategori' jadi 'katagori' kalau ada di nilai
                    $level_kode = str_ireplace('katagori', 'katagori', $value['A']);
                    $level_nama = str_ireplace('katagori', 'katagori', $value['B']);
